...
export class BaseRepository {
     ...
     */
    async findMany(where, options, tx) {
        try {
            // Use transaction client if provided, otherwise use default prisma client
            const client = tx || this.prisma;
     ...
     */
    async findManyWithPagination(where, options, tx) {
        try {
            // Use transaction client if provided, otherwise use default prisma client
            const client = tx || this.prisma;
     ...
     */
    async findFirst(where, options, tx) {
        try {
            // Use transaction client if provided, otherwise use default prisma client
            const client = tx || this.prisma;
     ...
     */
    async update(id, data, include, tx) {
        try {
            // Use transaction client if provided, otherwise use default prisma client
            const client = tx || this.prisma;
     ...
     */
    async upsert(where, create, update, include, tx) {
        try {
