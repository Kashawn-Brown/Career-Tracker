...
function buildFitSystemPrompt(): string {
  return [
    ...
    "",
    "- keywordGaps: max 10 UNIQUE items. Missing terms/tools worth noting for keyword coverage.",
    "  - Prefer tools/tech/platforms first, then architecture/process concepts.",
    "  - Do not repeat items already clearly stated in gaps.",
